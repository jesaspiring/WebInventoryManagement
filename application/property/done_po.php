                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <button type="button" class="btn btn-link" data-toggle="modal" data-target="#view_details<?php echo $purchOrder->PO_number; ?>">
                                    View Details
                                </button>

                                <!-- Modal -->
                                <?php echo form_open('PropertyCust/editBeforeEntry'); ?>
                                <div class="modal fade" id="view_details<?php echo  $purchOrder->PO_number; ?>" tabindex="-1" role="dialog" aria-labelledby="view_detailsLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h5 class="modal-title" id="view_detailsLabel">Items</h5>
                                            </div>
                                                ...
                                                <table class="table">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <button type="button" class="btn btn-link pull-right" data-toggle="modal" data-target="#edit">
                                                                    Edit
                                                                </button>
