        ...
        <div class="content-wrapper">
            ...
            <div class="box box-default">
                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                <th style="width: 16%"><h4>Qty</h4></th>
                                <th style="width: 16%"><h4>Unit</h4></th>
                                <th style="width: 16%"><h4>Item</h4></th>
                                <th style="width: 16%"><h4>Brand/Description</h4></th>
                                <th style="width: 16%"><h4>Control No.</h4></th>
                                <th style="width: 16%"><h4>Remarks</h4></th>
                            </tr>
                        </thead>
                        <tbody id="inventory">
