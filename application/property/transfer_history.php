        ...
        <div class="content-wrapper">
            ...
            <section class="content container-fluid">
                ...
                <table class="table" id = "table">
                    <thead>
                        <tr>
                            <th colspan="9" class="text-center"><h4><b>Transfer History</b></h4></th>
                        </tr>

                        <tr>
                            <th style="width: 11%"><h4>No.</h4></th>
                            <th style="width: 11%"><h4>Item ID</h4></th>
                            <th style="width: 11%"><h4>Item Name</h4></th>
                            <th style="width: 11%"><h4>Brand</h4></th>
                            <th style="width: 11%"><h4>Item Description</h4></th>
                            <th style="width: 11%"><h4>Control Number</h4></th>
                            <th style="width: 11%"><h4>Department</h4></th>
                            <th style="width: 11%"><h4>Dept Area</h4></th> 
                            <th style="width: 11%"><h4></h4></th>
                        </tr>
                    </thead>
                    <tbody id="inventory">
                        <?php
                        $counter = 1;
                        foreach ($trans_history as $item) :
                            ?>
                            <tr class="collapse row1 collapse in">
                                ...
                                <td>
                                    <button type="button" class="btn btn-link" data-toggle="modal" data-target="#exampleModal1<?php echo $item->transacID; ?>">
                                        View Details
                                    </button>

                                    <div class="modal fade" id="exampleModal1<?php echo $item->transacID; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModal1Label" aria-hidden="true">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <table class="table table-bordered">
                                                        <thead>
                                                            <th style="width: 40px">Transaction ID</th>
                                                            <th style="width: 40px">Item ID</th>
                                                            <th style="width: 40px">Transfer From</th>
                                                            <th style="width: 40px">Transfer To</th>
                                                            <th style="width: 40px">Quantity Transfered</th>
                                                            <th style="width: 70px">Date Transfer</th> 
                                                        </thead>
                                                        <tbody>
                                                            <td><?php echo $item->transacID; ?></td>
                                                            <td><?php echo $item->item_id; ?></td>
                                                            <td><?php echo $item->transfer_from; ?></td>
                                                            <td><?php echo $item->transfer_to; ?></td>
                                                            <td><?php echo $item->quantity; ?></td>
                                                            <td><?php echo $item->date_transfer; ?></td> 
                                                        </tbody>
                                                    </table>
