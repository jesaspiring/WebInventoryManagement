                ...
                <table class="table table-bordered" id="deptArea">
                    ...
                    <thead>
                        <tr class="clickable" data-toggle="collapse" id="row1" data-target=".row1">
                            <th colspan="11" class="text-center">Turnover History</th>
                        </tr>
                    </thead>
                    <thead>
                        <tr class="collapse row1 collapse in">
                            ...
                            <th style="width: 70px">Item Description</th>
                            <th style="width: 70px">Control Number</th>
                    ...
                    <tbody id="inventory">
                        <?php
                        $counter = 1;
                        foreach ($turnover_history as $item) :
                            ?>
                            <tr class="collapse row1 collapse in">
