                ...
                <div class="box box-default">
                    <div class="nav-tabs-custom">
                        <ul class="nav nav-tabs">
                            <li class="active"><a href="#received_items" data-toggle="tab">Received Items</a></li>
                            <li><a href="#with_discrepancy" data-toggle="tab">With Discrepancy</a></li>
                        </ul>
                        <div class="tab-content">
                                        ...
                                        foreach ($received as $received_items) :
                                            if ($reqID == $received_items->item_requestID) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control" name="receivedItemName[]" value="<?php echo $received_items->itemName ?>">

                                                    </td>
                                                    <td><input type="text" class="form-control" name="receivedItemBrand[]" value="<?php echo $received_items->brand ?>">

                                                    </td>
                                                    <td><input type="text" class="form-control" name="receivedItemModel[]" value="<?php echo $received_items->model ?>">

                                                    </td>
                                                    <td><input type="text" class="form-control" name="receivedItemDescription[]" value="<?php echo $received_items->itemDescription ?>">

                                                    </td>
                                                    <td><input type="text" class="form-control" name="receivedItemControl[]" value="<?php echo $received_items->control_no ?>">

                                                    </td>
                                                    <td><input type="text" class="form-control" name="receivedItemSerial[]" value="<?php echo $received_items->serial_number ?>">
                            ...
                            <!-- /.tab-pane -->
                            <div class="tab-pane" id="with_discrepancy">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th style="width: 2%">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($received as $received_items) :
                                            if ($reqID == $received_items->item_requestID) {
                                                if ($received_items->remarks == "wrong item" || $received_items->remarks == "substandard") {
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $no; ?></td>
                                                        ...
                                                        <td>
                                                            <label><?php echo $received_items->remarks?></label>
                                                        </td>
                                                    </tr>
                                        <?php $no++;
                                                }
