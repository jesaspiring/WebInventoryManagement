    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <div class="box box-default">
                    ...
                    <?php echo form_open('PropertyCust/editReceivingReport'); ?>
                    <br>
                    <div class="box-body">
                        <b>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td rowspan="2" class="text-center"> Category: <br>
                                        4582 <br>
                                        <input type="text" name="category" value="supplies"></td></td>
                ...
                <div class="box-footer">
                    ...
                    <button class="btn btn-primary hidden-print pull-right print-now">
                    ...
                    <script>
                        $(".print-now").on("click", function() { //the print button has the class .print-now
                            ...
                            $('.fa fa-calendar').removeClass('fa fa-calendar');
