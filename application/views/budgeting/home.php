        ...
        <div class="row">
          <div class="col-lg-6 col-xs-9">
            ...
            <div class="small-box bg-aqua">
              ...
              <a href="<?php echo base_url('index.php/approval/displayRequestBudgeting') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-6 col-xs-9">
            ...
            <div class="small-box bg-aqua">
              ...
              <a href="<?php echo base_url('index.php/approval/budgetLog') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
