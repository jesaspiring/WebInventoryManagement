        ...
        <div class="box box-default">
          <div class="box-body">
                ...
                <?php foreach ($items as $item) :
                  if ($item->requestID == $requestID) {
                    ...
                    <tr>
                      ...
                      <td>
                        <button type="button" class="btn btn-warning pull-right" data-toggle="modal" data-target="#exampleModal1<?php echo $item->itemID; ?>">
                              ...
                              <div class="modal-body">
                                ...
                                <div class="row">
                                  ...
                                  <div class="col-lg-6 col-sm-8">
                                    <h4>Description</h4>
                                    <textarea class="form-control" placeholder="Description" name="description" id="description"><?php echo $item->itemDescription; ?></textarea>
                                  </div>
                                </div>
                      ...
                      <td>
                        <?php
                            $attributes = array('onsubmit' => 'return submitDelete()');
                            echo form_open('PurchasingDept/delete_item', $attributes); ?>
                        <input type="text" name="itemID" value=<?php echo $item->itemID; ?> hidden />
                        <input type="text" name="reqID" value=<?php echo $item->requestID; ?> hidden />
                        <button type="submit" class="btn btn-danger pull-right"> <i class="glyphicon glyphicon-trash"></i> Delete</button>
                        </form>
                        <script>
            ...
            <div class="box-footer">
              ...
              echo form_open('PurchasingDept/submit_purchase_order', $attributes);
              ?>
              ...
              <button class="btn btn-primary hidden-print pull-left"><span class="glyphicon glyphicon-print" aria-hidden="true"></span> Print</button>
