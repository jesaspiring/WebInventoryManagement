            ...
            <table class="table" id="sorting">
              ...
              <tbody>
                <?php foreach ($po as $purchOrder) :
                  if ($purchOrder->request_id != 000000) {
                    if ($purchOrder->status != "Archived") {
                      ?>
                      <tr>
                        <td><?php echo $purchOrder->PO_number; ?></td>
                        <td><?php echo $purchOrder->order_date; ?></td>
                        <td><?php echo $purchOrder->date_received; ?></td>
                        <td><?php echo $purchOrder->status; ?>
                          <?php if ($purchOrder->status == "Delivery Complete") { ?>
                            <br />
                            <?php echo form_open('PurchasingDept/receivingReport'); ?>
                            <input type="text" name="poNum" value="<?php echo $purchOrder->PO_number; ?>" hidden>
                            <button type="submit" class="btn btn-link">View Receiving Report </button>
                            </form>
                          <?php } ?>
                        </td>
                        <td>
                          <?php if ($purchOrder->status == "Delivery Complete" || $purchOrder->status == "Cancelled") { ?>
                            <?php echo form_open('PurchasingDept/archive_po'); ?>
                            <button type="submit" class="btn btn-link" style="color: black" data-toggle="tooltip" data-placement="top" title="Archive">
                              <i class="ionicons ion-archive"></i>
                        ...
                        <td><button type="submit" class="btn btn-link">View Purchase Order</button>
                          <input type="text" name="poNumber" value="<?php echo $purchOrder->PO_number; ?>" hidden />
                          <input type="text" name="reqID" value="<?php echo $purchOrder->request_id; ?>" hidden />
                          </form>
                        </td>
                        ...
                        <td>
                        <?php if ($purchOrder->status != 'Cancelled') { ?>
                          <div class="dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                ...
                                <?php echo form_open('PurchasingDept/cancel_po'); ?>
                                <input type="text" name="poNumber" value="<?php echo $purchOrder->PO_number; ?>" hidden />
                                <input type="text" name="reqID" value="<?php echo $purchOrder->request_id; ?>" hidden />
