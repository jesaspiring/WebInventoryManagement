            ...
            <div class="row">
              <div class="col-lg-3 ">
                ...
                <div class="form-inline">
                  ...
                  <input type="text" style="width: 150px" class="form-control" readonly>
                </div> <!-- /.col -->
              </div>
            ...
            <div class="row">
              ...
              <div class="col-lg-3 col-xs-4">
                <div class="form-inline">
                  ...
                  <input type="text" class="form-control" style="width: 150px" value="<?php echo $form->account_no; ?>" readonly>
                </div>
              </div>
              <!-- /.col -->
              <div class="col-lg-4 col-xs-6">
                <div class="form-inline">
                  ...
                  <input type="text" class="form-control" value="<?php echo $form->account_name; ?>" readonly>
                  </div>
              </div>
                  <!-- /.col -->
                  ...
                  <input type="text" class="form-control" value="<?php echo $form->username; ?>" readonly>
                  </div>
                  </div>
                  <!-- /.col -->
                </div>
                ...
                <div class="row">
                  ...
                  <input type="text" style = "width: 75%" class="form-control" readonly>
                  </div>
                  </div>
                  ...
                  <div class="form-inline">
                    <div class="form-group col-mb-2">
                      ...
                      <input type="text" class="form-control" value="<?php echo $form->unit_head; ?>" readonly>
                    </div>
                  </div>
                  <!-- /.col -->
                </div>
                ...
                <div class="row">
                  ...
                  <input type="text" style = "width: 85%" class="form-control" readonly>
                  </div>
                  ...
                  <input type="text" class="form-control" value="<?php echo $form->purchase_officer; ?>" readonly>
                  </div>
                  <!-- /.col -->
                </div>
                </div>
                ...
                <button type="submit" class="btn btn-success pull-right"><i class="glyphicon glyphicon-save"></i>
                  <input type="hidden" name="reqID" value="<?php echo $form->requestID; ?>">
                  Save Changes
                </button>
              </form>
              ...
              <script>
               ...
               <?php echo form_open('PurchasingDept/print_rf'); ?>
