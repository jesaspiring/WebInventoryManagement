        ...
        <div class="content-wrapper">
            ...
            <section class="content container-fluid">
                <div class="box box-default">
                    <div class="box-body">
                    <h4><?php echo $this->session->flashdata('supplier_created'); ?></h4>
                    <?php 
                    $attributes = array('onsubmit' => 'return createSupplier()');
                     echo form_open('PurchasingDept/create_supplier', $attributes); ?>
                        <div class="row">
                            <div class="col-lg-2">
                                <h4>Name</h4>
                            </div>
                            <div class="col-lg-7">
                                <input type="text" class="form-control" placeholder="Enter Supplier's Name" name="supplier_name" value=>
                            </div> <!-- /.col -->
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                <input type="text" class="form-control" name="address" placeholder="Enter Supplier's Address">
                            </div> <!-- /.col -->
                        </div><!-- /.row -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                                <input type="text" class="form-control" name="contact_no" placeholder="Enter Supplier's Phone No.">
                            </div> <!-- /.col -->
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7">
                            <input type="text" class="form-control" name="email" placeholder="Enter Supplier's Email Address">
                        </div> <!-- /.col -->
                    </div>
                    ...
                    <div class="row">
                            ...
                            <div class="col-lg-7">
                            <input type="text" class="form-control" name="itemsSupplied" placeholder="Items Supplied">
                        </div> <!-- /.col -->
                    </div><!-- /.row -->

                <div class="box-footer">
                    <button type="submit" class="btn btn-success pull-right">Create Supplier</button>
                </div>
                </form>
        </div>
        <script>
