    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content container-fluid">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <?php foreach ($package as $package) : ?>
                                            <label>
                                                <input type="radio" value="<?php echo $package->package_id; ?>" name="category" class="minimal"></label> <?php echo $package->package_name; ?>
                                        <?php endforeach; ?>
                                    </div> <!-- /. modal-body -->
                            ...
                            <?php foreach ($item as $items) :
                                if ($items->requestID == $requestID) {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group pull-right">
                                                <?php echo form_open_multipart('PurchasingDept/do_upload'); ?>
                ...
                <?php echo form_open('page/purchasing'); ?>
