...
<body class="hold-transition skin-blue sidebar-mini">
    ...
    <thead>
        <tr class = "text-center">
            <th style = "width: 100px"><h4>Request ID</h4></th>
            <th style = "width: 100px"><h4>Date Approved</h4></th>
            <th style = "width: 100px"><h4>Requested By:</h4></th>
            <th style = "width: 100px"><h4>Department</h4></th>
    ...
    <tbody>
        <tr>
            ...
            <td>
              <button type = "button" class ="btn btn-default"><a href = "<?php echo base_url('index.php/ PurchasingDept/processPO') ?>">
              Process PO</a></button>
            </td>
        </tr>
    </tbody>
