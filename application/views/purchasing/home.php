        ...
        <div class="row">
          <div class="col-lg-6 col-xs-9">
            ...
            <div class="small-box bg-aqua">
              ...
              <a href="<?php echo base_url('index.php/approval/displayRequestPurchasing') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-6 col-xs-9">
          ...
          <div class="col-lg-6 col-xs-9">
            ...
            <div class="small-box bg-aqua">
              <div class="inner">
                <h3><?php echo $month; ?> Request Made</h3>

                <p><?php echo $monthly_request ?></p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-6 col-xs-9">
            ...
            <div class="small-box bg-aqua">
              <div class="inner">
                ...
                <p><?php echo $po_count; ?></p>
              </div>
              <div class="icon">
                <i class="fa fa-fw fa-envelope-o"></i>
              </div>
              <a href="<?php echo base_url('index.php/PurchasingDept/view_po') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
