                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <h5 class="modal-title" id="exampleModalLabel">Request ID: <?php echo $request->requestID; ?> </h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                              <span aria-hidden="true">&times;</span>
                            </button>
                          </div>
      ...
      <div class="dropdown">
        ...
        if ($request->status == "Pending Approval Purchasing") {
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            ...
            <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModal2<?php echo $request->requestID; ?>">
        ...
        if ($request->status == "Approved by Purchasing") {
          ...
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            ...
            <button type="submit" class="btn btn-success">Process Canvass Form</button>
            <input type="text" name="reqID" value=<?php echo $request->requestID; ?> hidden />
            <input type="text" name="itemID" value=<?php echo $items->itemID; ?> hidden />
            </form>
        ...
        <?php if ($request->status == "Processing") { ?>
          <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
            ...
            <button type="submit" class="btn btn-success">Print Canvass Form</button>
            <input type="text" name="reqID" value=<?php echo $request->requestID; ?> hidden />
            <input type="text" name="itemID" value=<?php echo $items->itemID; ?> hidden />
            </form>

            <?php echo form_open('PurchasingDept/processPO') ?>
            <button type="submit" class="btn btn-success">Process PO</button>
            <input type="text" name="reqID" value=<?php echo $request->requestID; ?> hidden />
            <input type="text" name="itemID" value=<?php echo $items->itemID; ?> hidden />
            </form>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <?php echo form_open("approval/declineRequestPurchasing"); ?>
              <input type="text" name="requestID" value=<?php echo $request->requestID; ?> hidden />
              <div class="form-group">
                <input class="form-control" name="comment" type="text" placeholder="Your comments" />
              </div>
