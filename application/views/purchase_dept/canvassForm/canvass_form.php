...
<body>
  ...
  <div class="box box-default">
    <div class="box-header text-center">
      ...
      <h1 class="box-title">PURCHASING OFFICE</h1><br><br>
      <h1 class="box-title"><u>C  A  N  V  A  S  S   F  O  R  M</u></h1>
        </div> <!--/.box header-->

        <div class="box-body">
            To Whom It May Concern:
            <br><br>
            Kindly fill out the canvass form and quote for your lowest price, inclusive of taxes and other charges to the following item(s).
        ...
        <thead>
          ...
          <br><br>
          Please indicate the availability of stocks.
          <br><br>
          Please send your quotations at (033) 3291661 ASAP or through email at purchasing@cpu.edu.ph<br>
          Thank You.
          <br><br><br>
          <div class = "container">
            <div class = "row">
