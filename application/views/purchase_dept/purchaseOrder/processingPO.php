    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content">
                ...
                <link rel="stylesheet" href="<?php echo base_url();?>assets/theme/bower_components/RequisitionForm/RequisitionFormCSS.css">
                <!--JQuery-->
                                ...
                                <tbody>
                                    <?php foreach ($item as $items) :
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" name="itemID" value=<?php echo $items->itemID; ?> hidden /></td>
                                        </tr>
                                    <?php
                                endforeach; ?>
                                    </tr>
