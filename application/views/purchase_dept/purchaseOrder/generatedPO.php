                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-2 col-sm-4">
                                                                            ...
                                                                            <input type="text" class="form-control" placeholder="Price per Unit" name="price" id="price" value="<?php echo $item->pricePerUnit; ?>">
                                                                        </div>
                                                                    </div>

                                                                    <input type="text" name="itemID" value=<?php echo $item->itemID; ?> hidden />
                                                                    <input type="text" name="poNum" value=<?php echo $item->PO_Number; ?> hidden />
