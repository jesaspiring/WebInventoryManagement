...
<body class="hold-transition skin-blue sidebar-mini">
                ...
                <body>
                    ...
                    <div class="box box-default">
                        ...
                        <div class="box-body">
                            ...
                            <form name="addItem" method="post" action="<?php echo site_url('PurchasingDept/addItem') ?>">
                                <div class="row">
                                    ...
                                    if ($items->requestID == $requestID) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <?php echo form_open('PurchasingDept/editItem'); ?>
                                            ...
                                            <td>
                                                <?php echo form_open('PurchasingDept/deleteItem'); ?>
                                                <input type="text" name="itemID" value=<?php echo $items->itemID; ?> hidden />
    ...
    <!--Table 2-->
    <form name="submitRequest" method="post" action="<?php echo site_url('PurchasingDept/submit_request') ?>">
        <div class="box-footer">
