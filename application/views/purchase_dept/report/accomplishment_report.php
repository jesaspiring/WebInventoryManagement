                ...
                <body>
                    ...
                    <div class="box box-default">
                        <div class="box-header with-border">
                            <h1 class="box-title">Accomplishment Report</h1>
                        </div>
                        <!--/.box header-->
                            ...
                            <table>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>Received a total of <input type="number" class="form-control" name="supplier" style="width: 50px" value="<?php echo $receivedRequest; ?>" /> requests</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Processed a total of <input type="number" name="supplier" style="width: 50px" value="<?php echo $processedRequest; ?>" /> requests
                                            <br><br>
                                            <input type="number" name="supplier" style="width: 50px" value="<?php echo $cashAdvance; ?>" /> cash advances <br>
                                            <input type="number" name="supplier" style="width: 50px" value="<?php echo $urgent; ?>" /> urgent requests </td>
                                        <td>Purchasing Officer<br>
                                            Purchasing Clerk<br>
                                            Work Student</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Prepared <input type="number" name="supplier" style="width: 50px" value="<?php echo $preparedPo; ?>" /> purchase orders</td>
                                        <td>Purchasing Officer <br>
                                            Purchasing Clerk <br>
                                            Work Student</td>
                                        <td></td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Prepared <input type="number" name="supplier" style="width: 50px" value="<?php echo $orderedPo; ?>" /> purchase orders</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Processed <input type="number" name="supplier" style="width: 50px" value /> purchase orders for
                                            payment.</td>
                                        <td>Purchasing Officer <br>
                                            Purchasing Clerk <br>
                                            Work Student</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>Accommodated<input type="number" name="supplier" style="width: 50px" value /> Suppliers in the office</textarea></td>
