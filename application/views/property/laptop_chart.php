            ...
            <section class="content container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12 col-xs-9">
                        ...
                        <h3><label>Select Statistics</label></h3>
                        <a href="<?php echo base_url('index.php/PropertyCust/chartReport'); ?>"><h4 style = "color: black; text-decoration"> Laptop Repairs</h4></a></li>
                        <a href="<?php echo base_url('index.php/PropertyCust/inventoryLaptopReport'); ?>"><h4 style = "color: black; text-decoration">  Total Laptops</h4></a></li>
