                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    echo form_open('PropertyCust/createReceivingReport', $attributes); ?>
                                    <td colspan="3"> Vendor: <input type="text" name="vendor" value="<?php echo $supplier; ?>" class="form-control"> </td>
                                    <td colspan=3> Invoice No./Date:
                                        <input type="text" name="invoice_no" class="form-control">
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan =3 >P.O.No. / Date:
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td rowspan="2" colspan = 2 class="text-center"> Category: <br>
                                        4582 <br>
                                    ...
                                    <td colspan = 2 rowspan = 2 class="text-center"> Received by:
                                        <br><br>
