                    ...
                    <div class="box-body">
                        ...
                        <div class="modal fade" id="transferItem" tabindex="-1" role="dialog" aria-labelledby="exampleModal1Label" aria-hidden="true">
                            <div class="modal-dialog modal-lg" style="width:85%" role="document">
                                <div class="modal-content">
                                    ...
                                    echo form_open('PropertyCust/itemTransferTransac', $attributes); ?>
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($items as $item) : ?>
                                                    <tr>
                                                        ...
                                                        <td><input type="checkbox" class = "minimal"  name="select[]" value="<?php echo $item->item_id; ?>"></td>
                        ...
                        <div class="box-footer">
                            <div class="btn-toolbar">
                                ...
                                echo form_open('PropertyCust/saveTransTransaction', $attributes); ?>
                                            ...
                                            <div class="modal-body">
                                                <div class="row">
                                                    <div class="col-lg-4">
                                                        ...
                                                        <input type="text" class = "form-control" name="deptFrom" value="<?php echo $dept_choice; ?>" readonly>
                                                    </div>
                                ...
                                <div class="btn-group pull-right">
                                    <?php $attributes = array('onsubmit' => 'return submitCancel()');
                                    echo form_open('PropertyCust/cancel_transfer', $attributes); ?>
