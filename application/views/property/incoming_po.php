                                    ...
                                    if ($purchOrder->status != "Incomplete Delivery" && $purchOrder->status != "Delivery Complete") {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <!--- <?php $attributes = array('onsubmit' => 'return submitValidate()');
                                                                echo form_open('PropertyCust/po_validation', $attributes); ?>
                                                    ...
                                                    <div class="modal-dialog modal-lg" style="width:80%" role="document">
                                                        ...
                                                        <div class="modal-content">
                                                                        ...
                                                                        <?php foreach ($item as $items) :
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>
                                                                                        ...
                                                                                        <input type="number" style="width: 80px" class="form-control" placeholder="Quantity" name="quantity_delivered[]" id="quantity_delivered" value="<?php echo $items->quantity; ?>">
                                                                                    </td>
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                </label> <input type="checkbox" class="minimal pull-right" name="to_inventory">
                                                                <br>
                                                                <!--done-->
