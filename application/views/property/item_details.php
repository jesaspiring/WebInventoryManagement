            ...
            <section class="content container-fluid">
                <div class="box box-default">
                    <div class="box-body">
                        ...
                        echo form_open('PropertyCust/editInventory', $attributes); ?>
                        <div class="row">
                            <div class="col-lg-3">
                                <h4>Control No.:</h4>
                        ...
                        <div class="row">
                            <div class="col-lg-5">
                                ...
                                <textarea class="form-control" name="description"><?php echo $item_details->item_description; ?></textarea>
                            </div> <!-- /.col -->
                            ...
                            <div class="col-lg-3">
                                ...
                                <?php if ($item_details->dept_section != 0) { ?>
                                    <h4>Department Area:</h4>
                                    <input type="text" class="form-control" value="<?php echo $item_details->areaName; ?>" readonly>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <h4>With Warranty:</h4>
                                <input type="text" class="form-control" name="status" <?php if($item_details->with_warranty == "1") echo "value=Yes";?>>
                            </div> <!-- /.col -->

                            <div class="col-lg-3">
                                <h4>Warranty Period:</h4>
                                <input type="text" class="form-control" name="status" value="<?php echo $item_details->warranty_period; ?>">
                            </div> <!-- /.col -->
                        </div> <!-- /.row -->
                            ...
                            <div class="btn-toolbar">
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-5">
                                                                    <input type="text" class="form-control" name="transfer_remark" placeholder="Enter Remarks"></td>
                                                                </div>
                                                            </div>
                                ...
                                <div class="btn-group pull-right">
                                    <button type="button" class="btn btn-danger pull-right" data-toggle="modal" data-target="#repair<?php echo $item_details->item_id; ?>">
                                        <i class="ionicons ion-hammer"></i> Repair Item
                                    </button>
                                    ...
                                    <div class="modal fade" id="repair<?php echo $item_details->item_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <?php $attributes = array('onsubmit' => 'return submitRepair()');
                                                echo form_open('PropertyCust/repair_item', $attributes); ?>
                                                <div class="modal-body">
                                                    <input type="text" name="control_no" value="<?php echo $item_details->control_number; ?>" hidden />
                                                    <input type="text" name="itemID" value="<?php echo $item_details->item_id; ?>" hidden />
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            <input type="text" class="form-control" name="repair_type" value="" placeholder="Enter Type of Repair">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            <input type="text" class="form-control" name="repair_loc" value="" placeholder="Enter Location">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            <input type="text" class="form-control" name="in_charge" value="" placeholder="Enter Name">
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-5">
                                                            <input type="text" class="form-control" value="" placeholder="Enter Repair">
                                                        </div>
                                                    </div>
                                                    <div class="modal-footer">
                                                        <input type="text" name="itemID" value="<?php echo $item_details->item_id; ?>" hidden />
                                ...
                                <div class="nav-tabs-custom">
                                    <ul class="nav nav-tabs">
                                        <li class="active"><a href="#transfer_history" data-toggle="tab">Transfer History</a></li>
                                        <li><a href="#repair_history" data-toggle="tab">Repair History</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="transfer_history">
                                    ...
                                    <!-- /.tab-pane -->
                                    <div class="tab-pane" id="repair_history">
