                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <td colspan="2"> Vendor: <input type="text" name="vendor" class="form-control" readonly> </td>
                                ...
                                <tr>
                                    <td>P.O.No. / Date:
                                        <input type="text" name="poNum" class="form-control" readonly>
                                    </td>
                                    <td>
                                        Date Ordered:
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="date_ordered" class="form-control pull-right" id="reservation">
                                            </div> <!-- /.input group -->
                                        </div> <!-- /.form group -->
                                    </td>
                                    <td colspan="2">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="delivery_date" class="form-control pull-right" id="reservation">
                                            </div> <!-- /.input group -->
                                        </div> <!-- /.form group -->
                                    </td>
                                </tr>
                                            ...
                                            <td> Date Recieved:
                                                <div class="form-group">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="date" name="date_received" class="form-control pull-right" id="reservation">
                                                    </div> <!-- /.input group -->
                                                </div> <!-- /.form group -->
                                            </td>
                                        </tr>
                ...
                <div class="box-footer">
                    ...
                    <script>
                        ...
                        function addRow() {
                            ...
                            column1.innerHTML = "<input type="
                            text " name="
                            quantity[]
                            " class="
                            form - control ">"
                            column2.innerHTML = "<input type="
                            text " name="
                            brand[]
                            " class="
                            form - control ">"
                            column3.innerHTML = "<input type="
                            text " name="
                            description[]
                            " class="
                            form - control ">"
                            column4.innerHTML = "<input type="
                            text " name="
                            price[]
                            " class="
                            form - control ">"
