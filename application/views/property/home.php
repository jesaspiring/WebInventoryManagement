        ...
        <div class="content-wrapper">
          ...
          <div class="col-lg-6 col-xs-9">
            ...
            <div class="small-box bg-aqua">
              ...
              <a href="<?php echo base_url('index.php/PropertyCust/showDepartment')?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-6 col-xs-9">
            ...
            <div class="small-box bg-aqua">
              <div class="inner">
                ...
                <p>All Receiving Reports</p>
              </div>
              <div class="icon">
                <i class="fa fa-fw fa-file-text"></i>
              </div>
              <a href="<?php echo base_url('index.php/PropertyCust/view_rr'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-6 col-xs-9">
            ...
            <div class="small-box bg-aqua">
              ...
              <a href="<?php echo base_url('index.php/PropertyCust/incoming_items'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-6 col-xs-9">
              ...
              <div class="small-box bg-aqua">
                ...
                <a href="<?php echo base_url('index.php/PropertyCust/pending_po'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <!-- ./col -->
            <div class="col-lg-6 col-xs-9">
              ...
              <div class="small-box bg-aqua">
                <div class="inner">
                  <h3>Un-assigned items </h3>
    
                  <p>(<?php echo $no_assigned;?>)</p>
                </div>
                <div class="icon">
                <i class="ionicons ion-android-checkbox-outline-blank"></i>
                </div>
                <a href="<?php echo base_url('index.php/PropertyCust/pending_po'); ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
              </div>
            </div>
            <div class="col-lg-6 col-xs-9">
              ...
              <div class="small-box bg-aqua">
                <div class="inner">
                  <h3>Not recorded in Inventory</h3>
    
                  <p>(<?php echo $not_recorded;?>)</p>
                </div>
                <div class="icon">
