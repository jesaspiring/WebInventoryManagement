                        ...
                        <?php foreach ($areas as $area) : ?>
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php foreach ($items as $item_detail) :
                                                                        if (
                                                                            ...
                                                                            ?>
                                                            #<?php echo $item_detail->serial_number; ?><br>
                                                    <?php }
                                                                endforeach; ?></td>
                                                <td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                            ...
                                                            <?php $attributes = array('onsubmit' => 'return submitDelete()');
                                                                        echo form_open('PropertyCust/deleteItem', $attributes); ?>
                            ...
                            <div class="box-footer">
                                ...
                                <?php $attributes = array('onsubmit' => 'return submitAdd()');
                                    echo form_open('PropertyCust/add_item', $attributes); ?>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-4 col-sm-8">
                                                        <h4>Item </h4>
                                                        <input type="text" list="item_selections" class="form-control" name="item" id="item" placeholder="Item">
                                                    ...
                                                    <div class="col-lg-4 col-sm-8">
                                                        <h4>Brand</h4>
                                                        <input type="text" list="item_brand" class="form-control" name="brand" id="brand" placeholder="Brand">
                                                    ...
                                                    <div class="col-lg-4 col-sm-8">
                                                        <h4>Model</h4>
                                                        <input type="text" list="item_model" class="form-control" name="model" id="model" placeholder="">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-sm-8">
                                                        <h4>Description</h4>
                                                        <textarea list="item_description" class="form-control" name="description" id="description" placeholder="Description"></textarea>
