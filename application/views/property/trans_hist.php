                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                ...
                                <?php echo form_open('PropertyCust/transfer_hist'); ?>
                            ...
                            <tbody id="inventory">
                                ...
                                foreach ($trans_history as $item) :
                                    ...
                                    <tr class="collapse row1 collapse in">
                                        ...
                                        <td><?php echo $item->transfer_number; ?></td>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-link" data-toggle="modal" data-target="#exampleModal1<?php echo $item->transfer_number; ?>">
                                                View Details
                                            </button>

                                            <div class="modal fade" id="exampleModal1<?php echo $item->transfer_number; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModal1Label" aria-hidden="true">
