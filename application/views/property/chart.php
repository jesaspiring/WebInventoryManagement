            ...
            <div class = "box box-default">
                ...
                <div class="row">
                    <div class="col-lg-12 col-xs-9">
                            ...
                            <a href="<?php echo base_url('index.php/PropertyCust/chartReport'); ?>"><h4 style = "color: Black; text-decoration: none">Laptop Repairs</h4></a>
                            <a href="<?php echo base_url('index.php/PropertyCust/inventoryLaptopReport'); ?>"><h4 style = "color: Black; text-decoration: none">Total Laptops</h4></a>
