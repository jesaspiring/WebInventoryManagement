                    ...
                    <div class="box-body">
                        ...
                        <table class="table table-bordered">
                            <thead>
                                ...
                                <tr>
                                <td  style = "border-right: none;"></td>
                                    <td style = "border-left: none;">P.O.No. / Date:
                            ...
                            <tbody>
                                ...
                                <tr>
                                <td style = "border-right: none;"></td>
                                    <td style = "border-left: none">Inspected by: <input type="text" value="<?php echo $rr->inspected_by;?>" name="inspected_by" class="form-control"></td>
