                ...
                <div class="box box-default">
                    <div class="box-body">
                        <table class="table" id="table1">
                            ...
                            <tbody>
                                <?php foreach ($receiving_report as $report) : ?>
                                    <tr>
                                        <td><?php echo $report->rr_no; ?></td>
                                        <td><?php echo $report->date_created; ?></td>
                                        <td><?php echo $report->processed_by; ?></td>
                                        <td><?php echo $report->date_edited; ?></td>
                                        <td>
                                            <?php echo form_open('PropertyCust/view_generated_rr'); ?>
                                            <input type="text" name="rr_no" value="<?php echo $report->rr_no; ?>" hidden>
