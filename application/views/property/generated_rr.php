        ...
        <div class="content-wrapper">
            ...
            <section class="content container-fluid">
                <div class="box box-default">
                        ...
                        <div class="container">
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-xs-4 pull-right">
                                    <b>RR No: </b>
                                    <h4><label><?php echo $rr->rr_no; ?></label></h4>
                                </div>
                                <!--/.col-->
                            </div>
                            <!--/. row-->
                    ...
                    echo form_open('PropertyCust/editReceivingReport', $attributes); ?>
                    <br>
                    <div class="box-body">
                        <b>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    <td colspan="2"> Vendor: <input type="text" name="vendor" value="<?php echo $rr->vendor; ?>" class="form-control" readonly> </td>
                                    <td colspan=3> Invoice No./Date:
                                        <input type="text" name="invoice_no" value="<?php echo $rr->invoice_no; ?>" class="form-control">
                                    </td>
                                </tr>
                                <tr>
                                    <td>P.O.No. / Date:
                                        <input type="text" name="poNum" value="<?php echo $rr->po_num; ?>" class="form-control" readonly>
                                    </td>
                                    <td colspans=2>
                                        Date Ordered:
                                        <div class="form-group" style = "width:100%">
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="date_ordered" value="<?php echo $rr->date_ordered; ?>" class="form-control pull-right" id="reservation">
                                            </div> <!-- /.input group -->
                                        </div> <!-- /.form group -->
                                    </td>
                                    <td colspan=3>
                                        ...
                                        <div class="form-group" style = "width:100%">
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="delivery_date" value="<?php echo $rr->delivery_date ?>" class="form-control pull-right" id="reservation">
                                            </div> <!-- /.input group -->
                                        </div> <!-- /.form group -->
                                    </td>
                                </tr>
                            ...
                            <tbody>
                                ...
                                <?php foreach ($items as $item) :
                                    if ($item->item_requestID == $rr->request_id) {
                                        ...
                                        <tr>
                                            ...
                                            <input type="text" name="requestID[]" value="<?php echo $item->item_requestID; ?>" hidden>
                                            <input type="text" name="itemID[]" value="<?php echo $item->itemID; ?>" hidden>
                                            <input type="text" name="item_no[]" value="<?php echo $item->item_no; ?>" hidden>
...
<tr>
                                ...
                                <tr>
                                    <td rowspan="2" class="text-center"> Category: <br>
                                        4582 <br>
                                        <input type="text" class = "form-control" name="category" value="supplies"></td>
                                    </td>
                                    <td class="text-center"> Delivered Via: <br>
                                        <input type="text" name="delivered_via" value="<?php echo $rr->delivered_via; ?>" class="form-control"></td>
                                    <td rowspan="2" class="text-center"> Recieved by:
                                        <br><br>
                                        <input type="text" name="received_by" value="<?php echo $rr->received_by; ?>" class="form-control">
                                        Signature over Printed Name
                                    </td>
                                    <td colspan=2>Department:<br>
                                        <input type="text" name="department" value="<?php echo $rr->department; ?>" class="form-control" readonly>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Inspected by: <input type="text" name="inspected_by" value="<?php echo $rr->inspected_by; ?>" class="form-control"></td>
                                    <td colspan=2> Date Recieved:
                                        <div class="form-group"style = "width:100%">
                                            <div class="input-group">
                                                ...
                                                <input type="date" name="date_received" value="<?php echo $rr->date_received; ?>" class="form-control pull-right" id="reservation">
                                            </div> <!-- /.input group -->
                                        </div> <!-- /.form group -->
                                    </td>
                                </tr>
                    ...
                    <div class="box-footer">
                        <input type="text" name="rr_no" value="<?php echo $rr->rr_no; ?>" hidden>
