                ...
                <div class="box box-default">
                        ...
                        <form name="addItem" method="post" action="<?php echo site_url('UserRequest/add_item'); ?>">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <textarea list="item_description" class="form-control" name="description" id="description"><?php echo set_value('description'); ?></textarea>
                    ...
                    <div class="box-footer">
                        <div class="btn-toolbar">
                            ...
                            <div class="btn-group pull-right">
                                <?php echo form_open('UserRequest/delete_all_item'); ?>
