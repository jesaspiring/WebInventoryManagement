        ...
        <small>Welcome <?php echo $this->session->userdata('username'); ?></small>
            ...
            <section class="content container-fluid">
                <div class="box box-default">
                    <div class="box-body">
                        <br>
                        <form name="addItem" method="post" action="<?php echo site_url('UserRequest/add_item_package'); ?>">
                            <div class="row">
                                <div class="col-lg-4">
                                    <label>
                                        <h4>Item</h4>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php foreach ($package_items as $items) :
                                if ($items->item_package_id == $packageID) {
                                    ?>
                                    <tr>
                                        <td><input type="checkbox" onclick="updateDeleteSelected(this)" value="<?php echo $items->item_id; ?>"></td>
                                        <td><?php echo $items->item_name; ?></td>
                                        <td><?php echo $items->brand; ?></td>
                                        <td><?php echo $items->model; ?></td>
                                        <td><textarea class="form-control" style="border: none;" rows="7"><?php echo $items->description; ?></textarea></td>
                                        <td><?php echo $items->unit; ?></td>
                                        <td><?php echo $items->quantity; ?></td>
                                        <td>
                                            <div class="btn-toolbar">
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-warning pull-right" data-toggle="modal" data-target="#exampleModal1<?php echo $items->item_id; ?>">
                                                        <i class="glyphicon glyphicon-edit"></i> Edit
                                                    </button>
                                                </div>

                                                <!-- Modal for Edit -->
                                                <?php echo form_open('UserRequest/edit_item_package'); ?>
                                                <div class="modal fade" id="exampleModal1<?php echo $items->item_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModal1Label" aria-hidden="true">
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="row">
                                                                    <div class="col-lg-4">
                                                                        <h4>Item </h4>
                                                                        <input type="text" class="form-control" placeholder="Item" name="item" id="item" value="<?php echo $items->item_name; ?>">
                                                                    </div>
                                                                    <div class="col-lg-4">
                                                                        <h4>Brand </h4>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <h4>Description</h4>
                                                                        <textarea class="form-control" name="description" id="description"><?php echo $items->description; ?></textarea>
                                                                    </div>
                                                                ...
                                                                <input type="text" name="itemID" value=<?php echo $items->item_id; ?> hidden />
                                                ...
                                                <div class="btn-group">
                                                    <?php echo form_open('UserRequest/delete_item_package'); ?>
                                                    <input type="text" name="itemID" value=<?php echo $items->item_id; ?> hidden />
                    ...
                    <div class="box-footer">
                        <div class="btn-toolbar">
                            <div class="btn-group pull-right">
                                <button type="button" class="btn btn-success pull-right" data-toggle="modal" data-target="#package">
                            ...
                            echo form_open('UserRequest/submit_package', $attributes);
                            ?>
                            <div class="modal fade" id="package" tabindex="-1" role="dialog" aria-labelledby="exampleModal1Label" aria-hidden="true">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                        ...
                                        <div class="modal-body">
                                                    <h4>Package Name </h4>
                                                    <input type="text" class="form-control" name="pack_name" value="<?php echo $packageName->package_name; ?>">
                                            ...
                                            <div class="modal-footer">
                                                <div class="btn-toolbar pull-right">
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <input type="hidden" value="<?php echo $packageID ?>" name="packageID">
                    ...
                    <div class="btn-group pull-right">
                        ...
                        echo form_open('UserRequest/delete_all_item_package', $attributes); ?>
