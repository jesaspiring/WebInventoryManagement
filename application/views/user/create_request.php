                ...
                <div class="box box-default">
                    ...
                    <?php echo form_open('UserRequest/new_request'); ?>
                        ...
                        <div class="form-group row">
                            <div class="col-lg-2">
                                <label>
                                    <h4>Funds Available: (Optional)</h4>
                                </label>
                            </div>
                            <div class="col-lg-4">
                                <input type="text" id="funds_avail" class="form-control" name="funds_avail" placeholder = "Funds Available">
