        ...
        <div class="row">
          <div class="col-lg-6 col-xs-12">
            ...
            <div class="small-box bg-aqua">
              ...
              <a href="<?php echo base_url('index.php/UserRequest/trackView') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-6 col-xs-12">
            ...
            <div class="small-box bg-aqua">
              <div class="inner">
                ...
                <p><?php echo $delivered_request; ?></p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-6 col-xs-12">
            ...
            <div class="small-box bg-aqua">
              <div class="inner">
                ...
                <p><?php echo $processed_request; ?></p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-6 col-xs-12">
            ...
            <div class="small-box bg-aqua">
              <div class="inner">
                ...
                <p><?php echo $total_draft; ?></p>
              </div>
              <div class="icon">
              <i class="fa fa-archive"></i>
              </div>
              <a href="<?php echo base_url('index.php/UserRequest/draft_request') ?>" class="small-box-footer">More info <i class="fa fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-6 col-xs-12">
