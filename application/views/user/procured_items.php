    ...
    <section class="sidebar">
      ...
      <li class = "header">
        ...
        <li class="treeview">
                    ...
                    <li><a href="<?php echo base_url('index.php/UserRequest/procured_items')?>"><i class="fa fa-circle-o"></i><span>Procured Items</span></a></li>
                ...
                <table class = "table">
                    <thead>
                        <tr>
                            ...
                            <th><h4>Model</h4></th>
                            <th><h4>Unit</h4></th>
                            <th><h4>Auantity</h4></th>
                            <th><h4>Price per Unit</h4></th>
                            <th><h4>Status/Date</h4></th>
                        </tr>
                    </thead>
