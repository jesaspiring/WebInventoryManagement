            ...
            <section class="content container-fluid">
                <div class = "box box-default">
                    ...
                    <div class="box-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php
                                                ...
                                                foreach ($package_items as $items) :
                                                    if ($items->item_package_id == $package->package_id) {
                                                        ?>

                                                    <?php


                                                                $subject .= $items->item_name . ', ';
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-link" data-toggle="modal" data-target="#view_details<?php echo $package->package_id; ?>">
                                                View Details
                                            </button>

                                            <!-- Modal -->
                                            <div class="modal fade" id="view_details<?php echo $package->package_id; ?>" tabindex="-1" role="dialog" aria-labelledby="view_detailsLabel" aria-hidden="true">
                                                            ...
                                                            <table class="table">
                                                                ...
                                                                <tbody>
                                                                    <?php foreach ($package_items as $item) :
                                                                            if ($package->package_id == $item->item_package_id) {
                                                                                ?>
                                                                            <tr>
                                                                                <td><?php echo $item->item_name; ?></td>
                                                                                <td><textarea class = "form-control" style = "border: none;" rows = "5"><?php echo $item->description; ?></textarea></td>
                                        ...
                                        <td>
                                            <div class="btn-toolbar">
                                                <div class="btn-group">
                                                    <?php echo form_open('UserRequest/edit_package'); ?>
                                                    ...
                                                    <input type="text" name="packageID" value=<?php echo $package->package_id; ?> hidden />
                                                    </form>
                                                </div>

                                                <div class="btn-group">
                                                    <?php $attributes = array('onsubmit' => 'return submitDelete()');
                                                    echo form_open('UserRequest/delete_package', $attributes); ?>
                                                    <button type="submit" style="color: red" class="btn btn-link ionicons ion-delete-button" data-toggle="tooltip" data-placement="top" title="Delete">
                        ...
                        <div class="footer">
                                <button type="button" class="btn btn-success pull-right" data-toggle="modal" data-target="#new_package">
                                <i class="glyphicon glyphicon-plus"></i> New Package
                                </button>

                                <!-- Modal -->
                                <div class="modal fade" id="new_package" tabindex="-1" role="dialog" aria-labelledby="view_detailsLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            ...
                                            <?php echo form_open('UserRequest/create_package'); ?>
                                            <div class="modal-body">
                                                    <h4>Package Name</h4>
                                                    <input type="text" class="form-control" name="new_package" placeholder= "Enter Package">
                                            </div>
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        $("#add_row").on("click", function() {
                            ...
                            cols += '<td><input type="text"  class="form-control" name="brand[]' + counter + '"/></td>';
                            cols += '<td><input type="text"  class="form-control name="model[]' + counter + '"/></td>';
                ...
                <script src="https://code.jquery.com/jquery-3.2.1.js">
                    $(document).ready(function() {
                        ...
                        $("#add_row").click(function() {
                            ...
                            $('#addr' + i).html("<td><input type='text' name='item_name[]' class='form-control'></td><td><input type='text' name='description[]' class='form-control'></td><td><input type='text' name='brand[]' class='form-control'></td><td><input type='text' name='model[]' class='form-control'/></td>");
