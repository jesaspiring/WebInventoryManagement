                ...
                <div class="box box-default">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group pull-right">
                                                <?php echo form_open_multipart('UserRequest/upload_file'); ?>
                                            ...
                                            <div class="btn-toolbar">
                                                ...
                                                <?php echo form_open('UserRequest/edit_returned_item'); ?>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <h4>Description</h4>
                                                                        <textarea class="form-control"><?php echo $items->itemDescription; ?></textarea>
                                                                    </div>
                    ...
                    <div class="box-footer">
                        <div class="btn-toolbar">
                            ...
                            <div class="btn-group pull-right">
                                <?php $attributes = array('onsubmit' => 'return submitDeleteSelected()');
                                echo form_open('UserRequest/delete_returned_items', $attributes); ?>
