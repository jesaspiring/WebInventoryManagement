                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        <div class="col-lg-4 col-sm-8">
                                                                                            <h4>Item </h4>
                                                                                            <input type="text" class="form-control" placeholder="Item" name="item" id="item" value="">
                                                                                        </div>
                                                                                        <div class="col-lg-4 col-sm-8">
                                                                                            <h4>Description</h4>
                                                                                        ...
                                                                                        <div class="col-lg-2 col-sm-4">
                                                                                            <h4>Control No.</h4>
                                                                                            <input type="text" class="form-control" placeholder="control_num" name="control_num" id="control_num" value="">
                                                                                        </div>

                                                                                        <div class="col-lg-2 col-sm-4">
                                                                                            <h4>Remarks</h4>
                                                                                            <input type="text" class="form-control" placeholder="remarks" name="remarks" id="remarks" value="">
                                                                                        </div>
                                                                                    </div>
                                                    ...
                                                    <table class="table" id="myTable">
                                                        ...
                                                        <tbody>
                                                            <?php foreach ($pending_item as $items) :
                                                                    if ($items->request_id == $purchOrder->request_id) {
                                                                        ?>
                                                            <tr>
                                                                <!--done-->
                                                                <td><?php echo $items->itemName; ?></td>
