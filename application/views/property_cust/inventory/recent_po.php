                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <?php foreach ($po as $purchOrder) :
                                if ($purchOrder->status === "Delivery Complete") {
                                    ?>
                            <tr>
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-lg-2 col-sm-4">
                                                                                            <h4>UCSC Control No.</h4>
                                                                                            <input type="text" class="form-control" placeholder="USCS Ctrl No." name="ucsc_ctrl" id="remarks" value="">
                                                                                        </div>
