                ...
                <div class="box box-default">
                    ...
                    <?php foreach ($areas as $area) : ?>
                        <table class="table table-bordered" id="deptArea">
                            ...
                            <thead>
                                <tr class="clickable" data-toggle="collapse" id="row1" data-target=".row1">
                                    <th colspan="8" class="text-center"><?php echo $area->areaName; ?></th>
                                </tr>
                            </thead>
                            <thead>
                                    ...
                                    if ($item->dept_section == $area->areaID) {
                                        ...
                                        <tr class="collapse row1 collapse in">
                                            ...
                                            <td>
                                                ...
                                                <?php echo form_open('PropertyCust/editItem'); ?>
                        ...
                        <div class="box-footer">
                            ...
                            <div class="box-footer">
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#addModal<?php echo $area->areaID; ?>">
                                    Add Item
                                </button>
