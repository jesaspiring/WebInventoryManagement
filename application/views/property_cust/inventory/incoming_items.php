                                                    ...
                                                    <table class="table" id="myTable">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#exampleModal1">
                                                                        Edit
                                                                    </button>
                                                                            ...
                                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="modal-body">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-lg-2 col-sm-4">
                                                                                            <h4>Control No.</h4>
                                                                                            <input type="text" class="form-control" placeholder="Control No." name="control_num" id="control_num" value="">
                                                                                        </div>


                                                                                        <div class="col-lg-2 col-sm-4">
                                                                                            <h4>Serial No.</h4>
                                                                                            <input type="text" class="form-control" placeholder="Remarks" name="serial" id="remarks" value="">
                                                                                        </div>
                                                                                    </div>
        ...
        <td>
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <?php echo form_open('PropertyCust/receivingReport'); ?>
                    ...
                    <button type="button" class="btn btn-link" data-toggle="modal" data-target="#incomplete<?php echo $purchOrder->PO_number; ?>">
                        Mark Incomplete
                    </button>



                    <button type="button" class="btn btn-link" data-toggle="modal" data-target="#exampleModal1<?php echo $purchOrder->PO_number; ?>">
                        Add to inventory
                    </button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <table class="table" id="myTable">
                                ...
                                <tbody>
                                    <?php echo form_open('PropertyCust/incomplete_po'); ?>
                                    <?php foreach ($item as $items) :
                                                if ($items->requestID == $purchOrder->request_id) {
                                                    ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="radio">
                                                <label><input type="checkbox" value="<?php echo $items->itemID?>" name="incomplete[]"></label>
                                            </div>
                                        </td>
                                        <td>
                                            <div class="col-lg-4 col-sm-8">
                                                <input type="text" placeholder="Quantity" name="quantity_left[]" id="quantity_left">
                                            </div>
                                        </td>
                                    </tr>
                                    <?php }
