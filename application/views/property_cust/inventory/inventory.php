        ...
        <script type="text/javascript">
            $(document).ready(function() {
                $('#department').change(function() {
                    var id = $(this).val();
                    $.ajax({
                        url: "<?php echo site_url('PropertyCust/display'); ?>",
                        method: "POST",
                        data: {
                            id: id
                        },
                    ...
                    <table class="table table-bordered" id="deptArea">
                        ...
                        <tbody id="inventory">
                            ...
                            <tr class="collapse row1 collapse in">
                                ...
                                <td>
                                    <button type="button" class="btn btn-primary pull-right" data-toggle="modal" data-target="#exampleModal1<?php echo $item->item_id; ?>">
                                        Edit
                                    </button>
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-lg-6">
                                                                        <h4>From (Select College/Department): </h4>
                                                                        <input type="text" name="deptFrom" style="width: 250px;" value="<?php echo $item->deptName;?>" readonly>
                                                                    </div>
                                                                    <div class="col-lg-6">
                                                                        <h4>To (Select College/Department): </h4>
                                ...
                                <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <!-- Button trigger modal -->
                                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModalrepair">
                                                Repair Item
                                            </button>

                                            <!-- Modal -->
                                            <?php echo form_open('PropertyCust/repair_item'); ?>
                                            <div class="modal fade" id="exampleModalrepair" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="exampleModalLabel">Transfer Item</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-6">
                                                                    <input type="text" name="repair_type" placeholder="Type of Repair" style="width: 250px;" value="" >
                                                                    <input type="text" name="repair_loc" placeholder="Repair Location" style="width: 250px;" value="" >
                                                                    <input type="text" name="in_charge" placeholder="In Charge" style="width: 250px;" value="" >
                                                                    <input type="text" name="remarks" placeholder="Remarks" style="width: 250px;" value="" >
                                                                </div>
                                                                <div class="col-lg-6">
                                ...
                                <td>
                                    ...
                                    <button type="submit" class="btn btn-success pull-right">View History</button>
                                    </form>
                                </td>
