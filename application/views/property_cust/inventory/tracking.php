              ...
              <div class="box box-default">
                <div class="box-body">
                  <ul class="nav nav-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                      <a class="nav-link active" id="jesiah-tab" data-toggle="tab" href="#jesiah" role="tab" aria-controls="jesiah" aria-selected="true">Transfer History</a>
                    </li>
                    <li class="nav-item">
                      <a class="nav-link" id="aguilar-tab" data-toggle="tab" href="#aguilar" role="tab" aria-controls="aguilar" aria-selected="false">Repair History</a>
                    </li>
                  </ul>

                  <div class="tab-content" id="myTabContent">
                    <div class="tab-pane fade show active" id="jesiah" role="tabpanel active" aria-labelledby="jesiah-tab">
