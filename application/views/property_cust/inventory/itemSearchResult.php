                ...
                <div class="box box-default">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-5">
                                <h4>Item</h4>
                                <?php echo form_open('PropertyCust/searchItem'); ?>
                                <input type="text" name="control_no" placeholder="Control No.">
                    ...
                    <table class="table table-bordered" id="deptArea">
                        ...
                        <thead>
                            <tr class="collapse row1 collapse in">
                                ...
                                <th style="width: 40px">Department Area</th>
                                                    ...
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="col-md-5">
                                                                ...
                                                                <select name="dept_area" id="dept_area">
