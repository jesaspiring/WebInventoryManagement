                    ...
                    <div class="box box-default">
                        <div class="box-header">
                            <div class="container">
                                <div class="row">
                                    ...
                                    <!--/.col-->
                                    <div class="col-lg-2">
                                        <b>RR No.</b><input type="text" value=<?php echo $rr_no; ?> class="form-control" readonly>
                                    </div>
                                    <!--/.col-->
                                </div>
                                <!--/. row-->
                        ...
                        <div class="box-body">
                            ...
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <td colspan="2"> Vendor: <input type="text" value="<?php echo $supplier; ?>" class="form-control" readonly> </td>
                                    ...
                                    <tr>
                                        <td>P.O.No. / Date:
                                            <input type="text" value="<?php echo $poNumber; ?>" class="form-control" readonly>
                                        </td>
                                        <td>
                                            Date Ordered:
                                            <div class="form-group">
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" value="<?php echo $dateOrdered; ?>" class="form-control pull-right" id="reservation">
                                                </div> <!-- /.input group -->
                                            </div> <!-- /.form group -->
                                        </td>
                                        <td colspan="2">
