            ...
            <table class="table" id="sorting">
              ...
              <tbody>
                <?php foreach ($request_log as $log) : ?>
                  <tr>
                    <td><?php echo $log->requestID; ?></td>
                    <td><?php echo $log->status; ?>
                      <p class="text-center">
                        <?php echo $log->trans_date; ?></p>
                    </td>
                    <td><?php echo $log->username?></td>
                    <td>

                      <button type="button" class="btn btn-link" data-toggle="modal" data-target="#exampleModal<?php echo $log->requestID;?>">
                        View Details
                      </button>

                      <div class="modal fade" id="exampleModal<?php echo $log->requestID;?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                              ...
                              <table class="table">
                                <thead>
                                  <tr>
                                    ...
                                    <th style="width: 12%"><h4>Attachment</h4></th>
                                  </tr>
                                </thead>

                                <tbody>
                                  <?php foreach ($item as $items) :
                                      if ($items->requestID == $log->requestID) {
                                        ?>
                                      <tr>
