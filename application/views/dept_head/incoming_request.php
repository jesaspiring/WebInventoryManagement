  ...
  <div class="wrapper">
    ...
    <div class="main-header">
      ...
      <nav class="navbar navbar-static-top" role="navigation">
        ...
        <a href="<?php echo base_url('index.php/page/user') ?>" class="sidebar-toggle" data-toggle="push-menu" role="button">
            ...
            <table class="table" id="example2">
              ...
              <tbody>
                <?php foreach ($query as $request) :
                  if ($request->department == $this->session->userdata('department')) {
                    ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <?php if ($items->attachment_name != "") { ?>
                              <a href="<?= base_url() . 'uploads/' . $items->attachment_name; ?>" target="_blank">Click Here</a>
                            <?php } ?>
                          </td>
            ...
            <div class="btn-toolbar">
              <div class="btn-group">
                <?php $attributes = array('onsubmit' => 'return submitRequest()');
                    echo form_open('approval/approveRequest', $attributes); ?>
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <?php
                        ...
                        echo form_open("approval/declineRequest", $attributes); ?>
                    <div class="user-panel">
                      <div class="pull-left image">
                        <img src="<?php echo base_url(); ?>/assets/theme/dist/img/user2-160x160.jpg" class="img-circle" alt="User Image">
                      </div>
