        ...
        <div class="navbar-custom-menu">
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              ...
              <li><a href ="<?php echo base_url('index.php/page/profile')?>"><h4><i class="glyphicon glyphicon-user"></i> Profile</h4></a></li>
    ...
    <div class="content-wrapper">
      ...
      <div class="box box-default">
          <div class="box-body">
            ...
            <?php $attributes = array('onsubmit' => 'return submitSaveRequest()');
